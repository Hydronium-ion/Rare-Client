...
export const Skeleton = styled.div`
  ...
  @media (max-width: ${({ theme }) => theme.sizes.md}) {
    background-image: linear-gradient(
      ...
      linear-gradient(lightgray 30%, transparent 0), linear-gradient(lightgray 95%, transparent 0),
      linear-gradient(lightgray 100%, transparent 0),
  ...
  @media (min-width: ${({ theme }) => theme.sizes.md}) {
    ...
    background-image: linear-gradient(
      ...
      linear-gradient(lightgray 20%, transparent 0), linear-gradient(lightgray 80%, transparent 0),
      linear-gradient(lightgray 100%, transparent 0),
