  ...
  return (
    <UserProfile ref={wrapperRef} onClick={toggleHandler}>
      ...
      <Icon icon="downArrow" size="0.4rem" />
      {
       opened && (
          <Content>
            <List><ListContainer>내 블로그</ListContainer></List>
            <List><ListContainer>책갈피</ListContainer></List>
            <List><ListContainer>팔로우</ListContainer></List>
            <List><ListContainer>설정</ListContainer></List>
            <List><ListContainer>로그아웃</ListContainer></List>
          </Content>
        )
      }
    </UserProfile>
